...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_text_display_master_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \B[2]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of E0_Received_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of E0_Received_i_5 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of E0_Received_i_6 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of E0_Received_i_8 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of E0_Received_i_9 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of Shift_pressed_i_3 : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_5\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_6\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of axi_wvalid_i_1 : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \col_pointer[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \col_pointer[2]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \col_pointer[3]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \col_pointer[3]_i_4\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \col_pointer[3]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \col_pointer[4]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \col_pointer[5]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \col_pointer[6]_i_3\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \col_pointer[6]_i_6\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \col_pointer[6]_i_8\ : label is "soft_lutpair36";
  ...
  attribute SOFT_HLUTNM of \i___76_carry__0_i_9\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \i__carry__0_i_10\ : label is "soft_lutpair41";
  ...
  attribute SOFT_HLUTNM of \i__carry__1_i_10\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \i__carry__1_i_11\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \i__carry__1_i_9\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \i__carry__2_i_11\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \i__carry__2_i_13\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \i__carry__2_i_9\ : label is "soft_lutpair43";
  ...
  attribute SOFT_HLUTNM of \m00_axi_araddr[31]_INST_0\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \m00_axi_awaddr[13]_INST_0_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \m00_axi_awaddr[14]_INST_0_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \m00_axi_awaddr[15]_INST_0_i_1\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \m00_axi_awaddr[15]_INST_0_i_12\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \m00_axi_awaddr[9]_INST_0_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \mst_exec_state[0]_i_3\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \mst_exec_state[0]_i_5\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_2\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_3\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \mst_exec_state[2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \mst_exec_state[2]_i_4\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \row_pointer[3]_i_2\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \row_pointer[4]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \row_pointer[5]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \row_pointer[5]_i_5\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \row_pointer[5]_i_6\ : label is "soft_lutpair44";
begin
...
E0_Received_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
E0_Received_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\col_pointer[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \mst_exec_state_reg_n_0_[2]\,
      I5 => \col_pointer[4]_i_2_n_0\,
      O => \col_pointer[4]_i_1_n_0\
    );
\col_pointer[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00E0E000"
    )
        port map (
...
\col_pointer[6]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
irq_delay_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_irq_delay
     port map (
      ...
      m00_axi_aclk => m00_axi_aclk,
      \mst_exec_state_reg[0]\ => \mst_exec_state[0]_i_5_n_0\,
      \mst_exec_state_reg[2]\ => \mst_exec_state[2]_i_6_n_0\,
      \mst_exec_state_reg[2]_0\ => \mst_exec_state_reg_n_0_[0]\,
      \mst_exec_state_reg[2]_1\ => \mst_exec_state_reg_n_0_[1]\,
      \mst_exec_state_reg[2]_2\ => \mst_exec_state_reg_n_0_[2]\
    );
...
\mst_exec_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFFFFFF4F40000"
    )
        port map (
      I0 => \mst_exec_state[0]_i_2_n_0\,
      I1 => \mst_exec_state[0]_i_3_n_0\,
      I2 => irq_delay_inst_n_1,
...
\mst_exec_state[1]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFFFFFF"
    )
        port map (
