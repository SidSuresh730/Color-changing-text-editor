...
HD_PWD='C:/Users/sidsu/VHDL/ECE4401/Final_Project/Final_Project.runs/design_1_text_display_master_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_text_display_master_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_text_display_master_0_0.tcl
