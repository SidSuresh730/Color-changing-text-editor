...
entity ps2lab_master_v1_0_M00_AXI is
	generic (
...
end ps2lab_master_v1_0_M00_AXI;

architecture implementation of ps2lab_master_v1_0_M00_AXI is
	...
	-- Example State machine to initialize counter, initialize write transactions, 
	 ...
	 type state is ( IDLE, -- This state initiates AXI4Lite transaction
					...
					KEYUP_DATARELEASE,
	 				SEGLED_WRITE);-- once writes are done, the state machine 
...
begin
	...
	--slave write address
	M_AXI_AWADDR	<= std_logic_vector (unsigned(C_M_7SEGLED_SLAVE_BASE_ADDR));
	--AXI 4 write data
	...
	-- Read data               
	  ...
	  variable F0_Received, E0_Received : std_logic;
    ...
    scancode2ascii_inst: scancode2ascii
        port map ( scancode => scancode, ascii => ascii );
